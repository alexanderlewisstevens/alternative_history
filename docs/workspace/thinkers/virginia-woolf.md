...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> authorship, education, feminism, material-conditions</span>
</div>
...
| Review rows | 13 |
| Review reasons | mixed_work_transition_page: 9<br>mixed_bibliography_and_work_title: 4<br>mixed_transition_page: 4<br>transition_from_previous_author: 4 |
...
| Git commit | `d54dce7` |
| Script version | `1` |
| Output path | `docs/workspace/thinkers/virginia-woolf.md` |
