...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> avant-garde, psychoanalysis, semiotics, subjectivity</span>
</div>
...
| --- | --- | ---: | ---: | --- | --- |
| [Revolution in Poetic Language](../norton-texts/kristeva-revolution-in-poetic-language.md) | 2213-2222 | 10 | 0 | [signs-and-reading](../signs-and-reading.md)<br>[commentary-and-afterlife](../commentary-and-afterlife.md) | `edition-review-needed` |
...
| Review rows | 14 |
| Review reasons | mixed_bibliography_and_work_title: 14<br>mixed_author_transition_page: 10<br>transition_from_previous_author: 4 |
...
| Git commit | `100eb5b` |
| Script version | `1` |
| Output path | `docs/workspace/thinkers/julia-kristeva.md` |
