...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> art, propaganda, public-culture, race</span>
</div>
...
| Review rows | 10 |
| Review reasons | mixed_work_transition_page: 7<br>mixed_bibliography_and_work_title: 3<br>mixed_transition_page: 3<br>transition_from_previous_author: 3 |
...
| Git commit | `d54dce7` |
| Script version | `1` |
| Output path | `docs/workspace/thinkers/web-du-bois.md` |
