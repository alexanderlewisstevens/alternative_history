...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> art, cultural-politics, race, vernacular</span>
</div>
...
| Review rows | 6 |
| Review reasons | mixed_bibliography_and_work_title: 3<br>transition_from_previous_author: 3<br>mixed_work_transition_page: 3 |
...
| Git commit | `100eb5b` |
| Script version | `1` |
| Output path | `docs/workspace/thinkers/langston-hughes.md` |
