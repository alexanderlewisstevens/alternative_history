...
| Signal | Value |
| --- | --- |
| Page kinds | excerpt: 26<br>author_intro: 4 |
| Review rows | 22 |
| Review reasons | source_notes_detected: 14<br>multi_column_layout: 12<br>mixed_bibliography_and_work_title: 5<br>mixed_transition_page: 5<br>transition_from_previous_author: 5 |
...
| Git commit | `0a93b4d` |
| Script version | `1` |
| Output path | `docs/workspace/thinkers/boris-eichenbaum.md` |
