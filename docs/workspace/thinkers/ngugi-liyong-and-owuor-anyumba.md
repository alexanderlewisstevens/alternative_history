...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> curriculum, education, language, postcolonialism</span>
</div>
...
| Review rows | 8 |
| Review reasons | mixed_bibliography_and_work_title: 8<br>mixed_author_transition_page: 5<br>transition_from_previous_author: 3 |
...
| Field | Value |
| --- | --- |
| Thinker slug | `ngugi-liyong-and-owuor-anyumba` |
...
| Git commit | `100eb5b` |
| Script version | `1` |
| Output path | `docs/workspace/thinkers/ngugi-liyong-and-owuor-anyumba.md` |
