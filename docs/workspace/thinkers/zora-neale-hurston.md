...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> artistic-freedom, language, performance, publishing, race, representation, vernacular</span>
</div>
...
| Signal | Value |
| --- | --- |
| Page kinds | excerpt: 17<br>author_intro: 2 |
| Review rows | 17 |
| Review reasons | mixed_work_transition_page: 13<br>mixed_bibliography_and_work_title: 2<br>transition_from_previous_author: 2<br>multi_column_layout: 2<br>source_notes_detected: 1 |
...
| Field | Value |
| --- | --- |
| Thinker slug | `zora-neale-hurston` |
