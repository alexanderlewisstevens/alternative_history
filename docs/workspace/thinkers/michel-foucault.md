...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> authorship, discipline, discourse, institution, institutions, intellectuals, interpretation, normalization, power, sexuality, subject-formation, truth</span>
</div>

<div class="ah-private-banner">
  <strong>Private thinker node</strong>
  <span>This page is generated from curated metadata and extraction audits. It contains no copied Norton source prose.</span>
</div>
...
| --- | --- | ---: | ---: | --- | --- |
| [What Is an Author?](../norton-texts/foucault-what-is-an-author.md) | 1666-1674 | 9 | 0 | [signs-and-reading](../signs-and-reading.md)<br>[commentary-and-afterlife](../commentary-and-afterlife.md)<br>[authorship-and-authority](../authorship-and-authority.md)<br>[media-and-form](../media-and-form.md)<br>[language-truth-and-fiction](../language-truth-and-fiction.md) | `edition-review-needed` |
| [Discipline and Punish](../norton-texts/foucault-discipline-and-punish.md) | 1675-1691 | 17 | 0 | [education-and-civic-life](../education-and-civic-life.md)<br>[vernacular-and-institution](../vernacular-and-institution.md)<br>[aesthetic-education-and-citizenship](../aesthetic-education-and-citizenship.md)<br>[labor-ideology-and-culture](../labor-ideology-and-culture.md) | `edition-review-needed` |
| [The History of Sexuality](../norton-texts/foucault-history-sexuality.md) | 1692-1710 | 7 | 0 | [vernacular-and-institution](../vernacular-and-institution.md)<br>[labor-ideology-and-culture](../labor-ideology-and-culture.md) | `edition-review-needed` |
| [Truth and Power](../norton-texts/foucault-truth-and-power.md) | 1711-1713 | 3 | 0 | [signs-and-reading](../signs-and-reading.md)<br>[commentary-and-afterlife](../commentary-and-afterlife.md)<br>[education-and-civic-life](../education-and-civic-life.md)<br>[vernacular-and-institution](../vernacular-and-institution.md)<br>[labor-ideology-and-culture](../labor-ideology-and-culture.md)<br>[language-truth-and-fiction](../language-truth-and-fiction.md) | `edition-review-needed` |
...
| Signal | Value |
| --- | --- |
| Page kinds | excerpt: 48<br>author_intro: 7 |
| Review rows | 43 |
| Review reasons | mixed_work_transition_page: 26<br>mixed_bibliography_and_work_title: 16<br>transition_from_previous_author: 7<br>multi_column_layout: 5<br>source_notes_detected: 4 |

## Passage Queue

<section class="ah-passage-card">
  <span class="ah-action-kicker">Anchor Candidates</span>
  <h3>Choose Passages After Text Review</h3>
  <p><strong>Source location:</strong> use linked text notes and restricted drafts.</p>
  <p><strong>Rights mode:</strong> private until an edition or translation is selected and reviewed.</p>
...
| Field | Value |
| --- | --- |
| Thinker slug | `michel-foucault` |
| Source ID | `norton-theory-criticism` |
| Source title | The Norton Anthology of Theory and Criticism |
| Source rights status | `copyrighted` |
| Generated at | `2026-06-13T06:37:18Z` |
| Git commit | `5771067` |
| Script version | `1` |
