...
| --- | --- | ---: | ---: | --- | --- |
| [Selected Enneads](../norton-texts/plotinus-enneads.md) | 213-226 | 7 | 0 | [beauty-and-ascent](../beauty-and-ascent.md) | `edition-review-needed` |
...
| Review rows | 7 |
| Review reasons | source_notes_detected: 6<br>multi_column_layout: 2 |
...
| Git commit | `bed2581` |
| Script version | `1` |
| Output path | `docs/workspace/thinkers/plotinus.md` |
