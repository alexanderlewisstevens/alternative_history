...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> citizenship, education, gender, reason</span>
</div>
...
| Review rows | 9 |
| Review reasons | transition_from_previous_author: 4<br>multi_column_layout: 4<br>source_notes_detected: 3<br>ocr_title_cleanup: 1 |
...
| Field | Value |
| --- | --- |
| Thinker slug | `mary-wollstonecraft` |
...
| Git commit | `5771067` |
| Script version | `1` |
| Output path | `docs/workspace/thinkers/mary-wollstonecraft.md` |
