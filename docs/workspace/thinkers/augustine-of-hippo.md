...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> authority, interpretation, signs, theology</span>
</div>
...
| Signal | Value |
| --- | --- |
| Page kinds | excerpt: 7<br>author_intro: 4 |
| Review rows | 9 |
| Review reasons | source_notes_detected: 5<br>transition_from_previous_author: 4<br>multi_column_layout: 1 |
...
| Field | Value |
| --- | --- |
| Thinker slug | `augustine-of-hippo` |
