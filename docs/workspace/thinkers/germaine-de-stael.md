...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> institutions, literature, nation, society</span>
</div>
...
| Review rows | 10 |
| Review reasons | multi_column_layout: 7<br>transition_from_previous_author: 3<br>source_notes_detected: 3<br>ocr_title_cleanup: 1 |
...
| Field | Value |
| --- | --- |
| Thinker slug | `germaine-de-stael` |
