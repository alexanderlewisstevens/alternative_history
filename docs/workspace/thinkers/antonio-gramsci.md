...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> education, hegemony, institutions, intellectuals</span>
</div>
...
| Field | Value |
| --- | --- |
| Thinker slug | `antonio-gramsci` |
| Source ID | `norton-theory-criticism` |
| Source title | The Norton Anthology of Theory and Criticism |
| Source rights status | `copyrighted` |
| Generated at | `2026-06-13T07:27:57Z` |
| Git commit | `100eb5b` |
| Script version | `1` |
| Output path | `docs/workspace/thinkers/antonio-gramsci.md` |
