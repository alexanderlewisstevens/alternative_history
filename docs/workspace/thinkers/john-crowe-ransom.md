...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> close-reading, criticism, new-criticism, university</span>
</div>
...
| Review rows | 13 |
| Review reasons | mixed_work_transition_page: 10<br>mixed_bibliography_and_work_title: 3<br>mixed_transition_page: 3<br>transition_from_previous_author: 3 |
...
| Field | Value |
| --- | --- |
| Thinker slug | `john-crowe-ransom` |
...
| Git commit | `5771067` |
| Script version | `1` |
| Output path | `docs/workspace/thinkers/john-crowe-ransom.md` |
