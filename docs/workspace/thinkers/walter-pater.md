...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> aestheticism, criticism, experience, perception</span>
</div>
...
| Review rows | 8 |
| Review reasons | mixed_work_transition_page: 6<br>transition_from_previous_author: 2 |
...
| Git commit | `9ddb58b` |
| Script version | `1` |
| Output path | `docs/workspace/thinkers/walter-pater.md` |
