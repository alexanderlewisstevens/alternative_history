...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> writing, logocentrism, deconstruction, method</span>
</div>
...
This note turns the current Norton chunk for Jacques Derrida into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 1866-1873</h3>
  ...
  <p><strong>Review pressure:</strong> 8 rows. mixed_bibliography_and_work_title: 8<br>mixed_work_transition_page: 8</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 1866-1873.</p>
...
<section class="ah-passage-card">
  ...
  <p><strong>Review signal:</strong> mixed_bibliography_and_work_title: 8<br>mixed_work_transition_page: 8</p>
...
| Field | Value |
| --- | --- |
| Text ID | `derrida-of-grammatology` |
| Curated title | Of Grammatology |
| Creator | Jacques Derrida |
| Thinker note | [Jacques Derrida](../thinkers/jacques-derrida.md) |
...
| Git commit | `e688291` |
| Script version | `3` |
| Output path | `docs/workspace/norton-texts/derrida-of-grammatology.md` |
...
<li>Thinker: <a href="../../thinkers/jacques-derrida/">Jacques Derrida</a></li>
