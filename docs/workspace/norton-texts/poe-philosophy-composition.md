...
This note turns the current Norton chunk for Edgar Allan Poe into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.
...
| Field | Value |
| --- | --- |
| Text ID | `poe-philosophy-composition` |
| Curated title | The Philosophy of Composition |
| Creator | Edgar Allan Poe |
| Thinker note | [Edgar Allan Poe](../thinkers/edgar-allan-poe.md) |
...
<li>Thinker: <a href="../../thinkers/edgar-allan-poe/">Edgar Allan Poe</a></li>
