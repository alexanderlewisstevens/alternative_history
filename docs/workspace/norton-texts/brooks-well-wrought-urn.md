...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> new-criticism, poetry, irony, paraphrase</span>
</div>
...
This note turns the current Norton chunk for Cleanth Brooks into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.
...
| Field | Value |
| --- | --- |
| Text ID | `brooks-well-wrought-urn` |
| Curated title | The Well Wrought Urn |
| Creator | Cleanth Brooks |
| Thinker note | [Cleanth Brooks](../thinkers/cleanth-brooks.md) |
...
<li>Thinker: <a href="../../thinkers/cleanth-brooks/">Cleanth Brooks</a></li>
