...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> authorship, discourse, institution, interpretation</span>
</div>
...
<section class="ah-passage-card">
  ...
  <p><strong>Review pressure:</strong> 9 rows. mixed_bibliography_and_work_title: 9<br>mixed_work_transition_page: 9</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 1666-1674.</p>
...
<section class="ah-passage-card">
  ...
  <p><strong>Review signal:</strong> mixed_bibliography_and_work_title: 9<br>mixed_work_transition_page: 9</p>
...
| Field | Value |
| --- | --- |
| Text ID | `foucault-what-is-an-author` |
| Curated title | What Is an Author? |
