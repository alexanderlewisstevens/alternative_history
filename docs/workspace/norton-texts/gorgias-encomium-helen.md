...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> rhetoric, persuasion, speech</span>
</div>
...
This note turns the current Norton chunk for Gorgias of Leontini into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.
...
<section class="ah-passage-card">
  ...
  <p><strong>Review signal:</strong> multi_column_layout: 2<br>mixed_excerpt_and_bibliography: 1<br>source_notes_detected: 1</p>
...
| Field | Value |
| --- | --- |
| Text ID | `gorgias-encomium-helen` |
| Curated title | Encomium of Helen |
| Creator | Gorgias |
| Thinker note | [Gorgias](../thinkers/gorgias-of-leontini.md) |
...
- Thinker: [Gorgias](../thinkers/gorgias-of-leontini.md)
