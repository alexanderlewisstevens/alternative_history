...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> anthropology, structuralism, writing, colonialism</span>
</div>
...
This note turns the current Norton chunk for Claude Levi-Strauss into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 1463-1470</h3>
  <p><strong>Page count:</strong> 8</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/claude-levi-strauss.md</code></p>
  <p><strong>Page kinds:</strong> excerpt: 8</p>
  <p><strong>Review pressure:</strong> 8 rows. mixed_work_transition_page: 8</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 1463-1470.</p>
  <p><strong>Rights mode:</strong> restricted private notes until a public-domain or otherwise usable reading copy is selected.</p>
  <p><strong>Use:</strong> Find the passages that make this text active inside signs-and-reading, vernacular-and-institution, media-and-form, labor-ideology-and-culture, language-truth-and-fiction.</p>
</section>

<section class="ah-passage-card">
  <span class="ah-action-kicker">Review Before Quoting</span>
  <h3>Layout, Notes, And Bibliography</h3>
  <p><strong>Review signal:</strong> mixed_work_transition_page: 8</p>
...
| Field | Value |
| --- | --- |
| Text ID | `levi-strauss-tristes-tropiques` |
| Curated title | Tristes Tropiques |
| Creator | Claude Levi-Strauss |
| Thinker note | [Claude Levi-Strauss](../thinkers/claude-levi-strauss.md) |
| Register status | `edition-review-needed` |
| Source anthology | The Norton Anthology of Theory and Criticism |
| Source rights status | `copyrighted` |
| Restricted draft | `generated/authors/norton-theory-criticism/claude-levi-strauss.md` |
| Workspace map | [Norton Workspace Map](../norton-map.md) |
| Generated at | `2026-06-13T07:13:46Z` |
| Git commit | `525b073` |
| Script version | `3` |
| Output path | `docs/workspace/norton-texts/levi-strauss-tristes-tropiques.md` |
...
<li>Thinker: <a href="../../thinkers/claude-levi-strauss/">Claude Levi-Strauss</a></li>
