...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> hermeneutics, interpretation, language, understanding</span>
</div>
...
This note turns the current Norton chunk for Friedrich Schleiermacher into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 652-667</h3>
  <p><strong>Page count:</strong> 16</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/friedrich-schleiermacher.md</code></p>
  <p><strong>Page kinds:</strong> excerpt: 12<br>author_intro: 3<br>mixed_excerpt_bibliography: 1</p>
  <p><strong>Review pressure:</strong> 14 rows. source_notes_detected: 9<br>transition_from_previous_author: 3<br>multi_column_layout: 2<br>mixed_excerpt_and_bibliography: 1</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Review signal:</strong> source_notes_detected: 9<br>transition_from_previous_author: 3<br>multi_column_layout: 2<br>mixed_excerpt_and_bibliography: 1</p>
...
| Field | Value |
| --- | --- |
| Text ID | `schleiermacher-hermeneutics` |
| Curated title | Hermeneutics |
| Creator | Friedrich Schleiermacher |
| Thinker note | [Friedrich Schleiermacher](../thinkers/friedrich-schleiermacher.md) |
...
<li>Thinker: <a href="../../thinkers/friedrich-schleiermacher/">Friedrich Schleiermacher</a></li>
