...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> native-studies, feminism, oral-tradition, interpretation</span>
</div>
...
This note turns the current Norton chunk for Paula Gunn Allen into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 2165-2169</h3>
  <p><strong>Page count:</strong> 5</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/paula-gunn-allen.md</code></p>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 2165-2169.</p>
...
| Field | Value |
| --- | --- |
| Text ID | `allen-kochinnenako-in-academe` |
| Curated title | Kochinnenako in Academe |
| Creator | Paula Gunn Allen |
| Thinker note | [Paula Gunn Allen](../thinkers/paula-gunn-allen.md) |
...
<li>Thinker: <a href="../../thinkers/paula-gunn-allen/">Paula Gunn Allen</a></li>
