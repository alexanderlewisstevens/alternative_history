...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> beauty, form, metaphysics</span>
</div>
...
This note turns the current Norton chunk for Plotinus into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 213-226</h3>
  <p><strong>Page count:</strong> 14</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/plotinus.md</code></p>
  <p><strong>Page kinds:</strong> excerpt: 10<br>author_intro: 4</p>
  <p><strong>Review pressure:</strong> 7 rows. source_notes_detected: 6<br>multi_column_layout: 2</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 213-226.</p>
  <p><strong>Rights mode:</strong> restricted private notes until a public-domain or otherwise usable reading copy is selected.</p>
  <p><strong>Use:</strong> Find the passages that make this text active inside beauty-and-ascent.</p>
</section>

<section class="ah-passage-card">
  <span class="ah-action-kicker">Review Before Quoting</span>
  <h3>Layout, Notes, And Bibliography</h3>
  <p><strong>Review signal:</strong> source_notes_detected: 6<br>multi_column_layout: 2</p>
...
| Field | Value |
| --- | --- |
| Text ID | `plotinus-enneads` |
| Curated title | Selected Enneads |
| Creator | Plotinus |
| Thinker note | [Plotinus](../thinkers/plotinus.md) |
...
<li>Thinker: <a href="../../thinkers/plotinus/">Plotinus</a></li>
