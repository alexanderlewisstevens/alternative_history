...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> language, being, poetry, dwelling</span>
</div>
...
This note turns the current Norton chunk for Martin Heidegger into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.
...
| Field | Value |
| --- | --- |
| Text ID | `heidegger-language` |
| Curated title | Language |
| Creator | Martin Heidegger |
| Thinker note | [Martin Heidegger](../thinkers/martin-heidegger.md) |
...
<li>Thinker: <a href="../../thinkers/martin-heidegger/">Martin Heidegger</a></li>
