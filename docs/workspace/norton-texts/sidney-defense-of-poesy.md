...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> poetry, rhetoric, education, civic-formation</span>
</div>
...
This note turns the current Norton chunk for Sir Philip Sidney into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.
...
| Field | Value |
| --- | --- |
| Text ID | `sidney-defense-of-poesy` |
| Curated title | The Defense of Poesy |
| Creator | Sir Philip Sidney |
| Thinker note | [Sir Philip Sidney](../thinkers/sir-philip-sidney.md) |
...
<li>Thinker: <a href="../../thinkers/sir-philip-sidney/">Sir Philip Sidney</a></li>
