...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> rhetoric, education, civic-formation</span>
</div>
...
This note turns the current Norton chunk for Quintilian into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.
...
<section class="ah-passage-card">
  ...
  <p><strong>Review signal:</strong> multi_column_layout: 8<br>source_notes_detected: 7<br>mixed_excerpt_and_bibliography: 1</p>
...
| Field | Value |
| --- | --- |
| Text ID | `quintilian-institutio-oratoria` |
| Curated title | Institutio Oratoria |
| Creator | Quintilian |
| Thinker note | [Quintilian](../thinkers/quintilian.md) |
...
<li>Thinker: <a href="../../thinkers/quintilian/">Quintilian</a></li>
