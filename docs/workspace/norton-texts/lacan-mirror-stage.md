...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> psychoanalysis, subjectivity, identification, image</span>
</div>
...
This note turns the current Norton chunk for Jacques Lacan into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 1329-1333</h3>
  <p><strong>Page count:</strong> 5</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/jacques-lacan.md</code></p>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 1329-1333.</p>
  <p><strong>Rights mode:</strong> restricted private notes until a public-domain or otherwise usable reading copy is selected.</p>
  <p><strong>Use:</strong> Find the passages that make this text active inside the workspace.</p>
</section>
...
| Field | Value |
| --- | --- |
| Text ID | `lacan-mirror-stage` |
| Curated title | The Mirror Stage as Formative of the Function of the I as Revealed in Psychoanalytic Experience |
| Creator | Jacques Lacan |
| Thinker note | [Jacques Lacan](../thinkers/jacques-lacan.md) |
| Register status | `edition-review-needed` |
| Source anthology | The Norton Anthology of Theory and Criticism |
| Source rights status | `copyrighted` |
| Restricted draft | `generated/authors/norton-theory-criticism/jacques-lacan.md` |
| Workspace map | [Norton Workspace Map](../norton-map.md) |
| Generated at | `2026-06-13T07:13:46Z` |
| Git commit | `525b073` |
| Script version | `3` |
| Output path | `docs/workspace/norton-texts/lacan-mirror-stage.md` |
...
<li>Thinker: <a href="../../thinkers/jacques-lacan/">Jacques Lacan</a></li>
<li><a href="../../passages/">Passage Notes</a></li>
<li>No constellation backlinks yet.</li>
</ul>
