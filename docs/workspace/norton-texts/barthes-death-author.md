...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> authorship, reader, poststructuralism, writing</span>
</div>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 1509-1511.</p>
  <p><strong>Rights mode:</strong> restricted private notes until a public-domain or otherwise usable reading copy is selected.</p>
  <p><strong>Use:</strong> Find the passages that make this text active inside commentary-and-afterlife, authorship-and-authority, language-truth-and-fiction.</p>
</section>
...
| Field | Value |
| --- | --- |
| Text ID | `barthes-death-author` |
| Curated title | The Death of the Author |
