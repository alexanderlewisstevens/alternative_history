...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> truth, power, institutions, intellectuals</span>
</div>
...
<section class="ah-passage-card">
  ...
  <p><strong>Review pressure:</strong> 3 rows. mixed_author_transition_page: 3</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 1711-1713.</p>
  <p><strong>Rights mode:</strong> restricted private notes until a public-domain or otherwise usable reading copy is selected.</p>
  <p><strong>Use:</strong> Find the passages that make this text active inside signs-and-reading, commentary-and-afterlife, education-and-civic-life, vernacular-and-institution, labor-ideology-and-culture, language-truth-and-fiction.</p>
</section>

<section class="ah-passage-card">
  <span class="ah-action-kicker">Review Before Quoting</span>
  <h3>Layout, Notes, And Bibliography</h3>
  <p><strong>Review signal:</strong> mixed_author_transition_page: 3</p>
...
| Field | Value |
| --- | --- |
| Text ID | `foucault-truth-and-power` |
| Curated title | Truth and Power |
...
| Git commit | `100eb5b` |
| Script version | `3` |
| Output path | `docs/workspace/norton-texts/foucault-truth-and-power.md` |
