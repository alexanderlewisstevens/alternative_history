...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> interpretation, pragmatism, intention, theory</span>
</div>
...
This note turns the current Norton chunk for Steven Knapp and Walter Benn Michaels into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 2504-2518</h3>
  <p><strong>Page count:</strong> 15</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/steven-knapp-and-walter-benn-michaels.md</code></p>
  <p><strong>Page kinds:</strong> excerpt: 15</p>
  <p><strong>Review pressure:</strong> 15 rows. mixed_author_transition_page: 15<br>mixed_bibliography_and_work_title: 15</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 2504-2518.</p>
  <p><strong>Rights mode:</strong> restricted private notes until a public-domain or otherwise usable reading copy is selected.</p>
  <p><strong>Use:</strong> Find the passages that make this text active inside signs-and-reading, commentary-and-afterlife, education-and-civic-life, aesthetic-education-and-citizenship, labor-ideology-and-culture.</p>
</section>

<section class="ah-passage-card">
  <span class="ah-action-kicker">Review Before Quoting</span>
  <h3>Layout, Notes, And Bibliography</h3>
  <p><strong>Review signal:</strong> mixed_author_transition_page: 15<br>mixed_bibliography_and_work_title: 15</p>
...
| Field | Value |
| --- | --- |
| Text ID | `knapp-michaels-against-theory` |
| Curated title | Against Theory |
| Creator | Steven Knapp and Walter Benn Michaels |
| Thinker note | [Steven Knapp and Walter Benn Michaels](../thinkers/steven-knapp-and-walter-benn-michaels.md) |
| Register status | `edition-review-needed` |
| Source anthology | The Norton Anthology of Theory and Criticism |
| Source rights status | `copyrighted` |
| Restricted draft | `generated/authors/norton-theory-criticism/steven-knapp-and-walter-benn-michaels.md` |
| Workspace map | [Norton Workspace Map](../norton-map.md) |
| Generated at | `2026-06-13T07:13:48Z` |
| Git commit | `525b073` |
| Script version | `3` |
| Output path | `docs/workspace/norton-texts/knapp-michaels-against-theory.md` |
...
<li>Thinker: <a href="../../thinkers/steven-knapp-and-walter-benn-michaels/">Steven Knapp and Walter Benn Michaels</a></li>
