...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> philology, theory, pedagogy, rhetoric</span>
</div>
...
<section class="ah-passage-card">
  ...
  <p><strong>Review pressure:</strong> 4 rows. multi_column_layout: 4<br>source_notes_detected: 1</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 1571-1575.</p>
  <p><strong>Rights mode:</strong> restricted private notes until a public-domain or otherwise usable reading copy is selected.</p>
  <p><strong>Use:</strong> Find the passages that make this text active inside signs-and-reading, commentary-and-afterlife, education-and-civic-life, authorship-and-authority, taste-and-standards, aesthetic-education-and-citizenship, language-truth-and-fiction.</p>
</section>

<section class="ah-passage-card">
  <span class="ah-action-kicker">Review Before Quoting</span>
  <h3>Layout, Notes, And Bibliography</h3>
  <p><strong>Review signal:</strong> multi_column_layout: 4<br>source_notes_detected: 1</p>
...
| Field | Value |
| --- | --- |
| Text ID | `de-man-return-to-philology` |
| Curated title | The Return to Philology |
| Creator | Paul de Man |
...
| Git commit | `525b073` |
| Script version | `3` |
| Output path | `docs/workspace/norton-texts/de-man-return-to-philology.md` |
