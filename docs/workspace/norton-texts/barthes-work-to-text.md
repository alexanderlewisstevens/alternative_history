...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> textuality, intertextuality, reader, poststructuralism</span>
</div>
...
This note turns the current Norton chunk for Roland Barthes into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 1512-1518</h3>
  <p><strong>Page count:</strong> 7</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/roland-barthes.md</code></p>
  <p><strong>Page kinds:</strong> excerpt: 7</p>
  <p><strong>Review pressure:</strong> 7 rows. mixed_work_transition_page: 7</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 1512-1518.</p>
...
<section class="ah-passage-card">
  ...
  <p><strong>Review signal:</strong> mixed_work_transition_page: 7</p>
...
| Field | Value |
| --- | --- |
| Text ID | `barthes-work-to-text` |
| Curated title | Work to Text |
| Creator | Roland Barthes |
| Thinker note | [Roland Barthes](../thinkers/roland-barthes.md) |
...
| Git commit | `525b073` |
| Script version | `3` |
| Output path | `docs/workspace/norton-texts/barthes-work-to-text.md` |
...
<li>Thinker: <a href="../../thinkers/roland-barthes/">Roland Barthes</a></li>
