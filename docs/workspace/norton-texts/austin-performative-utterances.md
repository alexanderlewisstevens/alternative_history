...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> speech-acts, ordinary-language, performativity, philosophy</span>
</div>
...
This note turns the current Norton chunk for J. L. Austin into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 1474-1485</h3>
  <p><strong>Page count:</strong> 12</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/j-l-austin.md</code></p>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 1474-1485.</p>
  <p><strong>Rights mode:</strong> restricted private notes until a public-domain or otherwise usable reading copy is selected.</p>
  <p><strong>Use:</strong> Find the passages that make this text active inside signs-and-reading, vernacular-and-institution, media-and-form, language-truth-and-fiction.</p>
</section>
...
| Field | Value |
| --- | --- |
| Text ID | `austin-performative-utterances` |
| Curated title | Performative Utterances |
| Creator | J. L. Austin |
| Thinker note | [J. L. Austin](../thinkers/j-l-austin.md) |
| Register status | `edition-review-needed` |
| Source anthology | The Norton Anthology of Theory and Criticism |
| Source rights status | `copyrighted` |
| Restricted draft | `generated/authors/norton-theory-criticism/j-l-austin.md` |
| Workspace map | [Norton Workspace Map](../norton-map.md) |
| Generated at | `2026-06-13T07:13:46Z` |
| Git commit | `525b073` |
| Script version | `3` |
| Output path | `docs/workspace/norton-texts/austin-performative-utterances.md` |
...
<li>Thinker: <a href="../../thinkers/j-l-austin/">J. L. Austin</a></li>
