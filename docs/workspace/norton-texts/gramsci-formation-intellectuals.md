...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> hegemony, intellectuals, education, institutions</span>
</div>
...
This note turns the current Norton chunk for Antonio Gramsci into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 1182-1187</h3>
  <p><strong>Page count:</strong> 6</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/antonio-gramsci.md</code></p>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 1182-1187.</p>
  <p><strong>Rights mode:</strong> restricted private notes until a public-domain or otherwise usable reading copy is selected.</p>
  <p><strong>Use:</strong> Find the passages that make this text active inside commentary-and-afterlife, education-and-civic-life, aesthetic-education-and-citizenship, labor-ideology-and-culture.</p>
</section>
...
| Field | Value |
| --- | --- |
| Text ID | `gramsci-formation-intellectuals` |
| Curated title | The Formation of the Intellectuals |
| Creator | Antonio Gramsci |
| Thinker note | [Antonio Gramsci](../thinkers/antonio-gramsci.md) |
| Register status | `edition-review-needed` |
| Source anthology | The Norton Anthology of Theory and Criticism |
| Source rights status | `copyrighted` |
| Restricted draft | `generated/authors/norton-theory-criticism/antonio-gramsci.md` |
| Workspace map | [Norton Workspace Map](../norton-map.md) |
| Generated at | `2026-06-13T07:13:46Z` |
| Git commit | `525b073` |
| Script version | `3` |
| Output path | `docs/workspace/norton-texts/gramsci-formation-intellectuals.md` |
...
<li>Thinker: <a href="../../thinkers/antonio-gramsci/">Antonio Gramsci</a></li>
