...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> new-historicism, renaissance, power, cultural-poetics</span>
</div>
...
This note turns the current Norton chunk for Stephen Greenblatt into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 2295-2298</h3>
  <p><strong>Page count:</strong> 4</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/stephen-greenblatt.md</code></p>
  <p><strong>Page kinds:</strong> excerpt: 4</p>
  <p><strong>Review pressure:</strong> 4 rows. mixed_bibliography_and_work_title: 4</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 2295-2298.</p>
  <p><strong>Rights mode:</strong> restricted private notes until a public-domain or otherwise usable reading copy is selected.</p>
  <p><strong>Use:</strong> Find the passages that make this text active inside signs-and-reading, commentary-and-afterlife, labor-ideology-and-culture.</p>
</section>

<section class="ah-passage-card">
  <span class="ah-action-kicker">Review Before Quoting</span>
  <h3>Layout, Notes, And Bibliography</h3>
  <p><strong>Review signal:</strong> mixed_bibliography_and_work_title: 4</p>
...
| Field | Value |
| --- | --- |
| Text ID | `greenblatt-introduction-power-of-forms` |
| Curated title | Introduction to The Power of Forms in the English Renaissance |
| Creator | Stephen Greenblatt |
| Thinker note | [Stephen Greenblatt](../thinkers/stephen-greenblatt.md) |
| Register status | `edition-review-needed` |
| Source anthology | The Norton Anthology of Theory and Criticism |
| Source rights status | `copyrighted` |
| Restricted draft | `generated/authors/norton-theory-criticism/stephen-greenblatt.md` |
| Workspace map | [Norton Workspace Map](../norton-map.md) |
| Generated at | `2026-06-13T07:19:07Z` |
| Git commit | `e8608c4` |
| Script version | `3` |
| Output path | `docs/workspace/norton-texts/greenblatt-introduction-power-of-forms.md` |
...
<li>Thinker: <a href="../../thinkers/stephen-greenblatt/">Stephen Greenblatt</a></li>
