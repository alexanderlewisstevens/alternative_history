...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> psychoanalysis, language, unconscious, signifier</span>
</div>
...
<section class="ah-passage-card">
  ...
  <p><strong>Review pressure:</strong> 12 rows. mixed_work_transition_page: 12</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 1334-1345.</p>
...
<section class="ah-passage-card">
  ...
  <p><strong>Review signal:</strong> mixed_work_transition_page: 12</p>
...
| Field | Value |
| --- | --- |
| Text ID | `lacan-agency-letter` |
| Curated title | The Agency of the Letter in the Unconscious |
...
| Git commit | `525b073` |
| Script version | `3` |
| Output path | `docs/workspace/norton-texts/lacan-agency-letter.md` |
