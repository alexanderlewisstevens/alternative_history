...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> poetics, linguistics, semiotics, form</span>
</div>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 1302-1307.</p>
...
| Field | Value |
| --- | --- |
| Text ID | `jakobson-linguistics-and-poetics` |
| Curated title | Linguistics and Poetics |
...
| Git commit | `525b073` |
| Script version | `3` |
| Output path | `docs/workspace/norton-texts/jakobson-linguistics-and-poetics.md` |
