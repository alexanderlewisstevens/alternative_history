...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> language, signs, structure, semiology</span>
</div>
...
This note turns the current Norton chunk for Ferdinand de Saussure into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.
...
| Field | Value |
| --- | --- |
| Text ID | `saussure-course-general-linguistics` |
| Curated title | Course in General Linguistics |
| Creator | Ferdinand de Saussure |
| Thinker note | [Ferdinand de Saussure](../thinkers/ferdinand-de-saussure.md) |
...
<li>Thinker: <a href="../../thinkers/ferdinand-de-saussure/">Ferdinand de Saussure</a></li>
