# Joseph Addison, The Spectator, Nos. 62 and 412
...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> wit, imagination, taste, public-sphere</span>
</div>
...
This note turns the current Norton chunk for Joseph Addison into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 458-467</h3>
  <p><strong>Page count:</strong> 10</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/joseph-addison.md</code></p>
  <p><strong>Page kinds:</strong> excerpt: 7<br>author_intro: 3</p>
  <p><strong>Review pressure:</strong> 10 rows. multi_column_layout: 6<br>source_notes_detected: 6<br>transition_from_previous_author: 3</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 458-467.</p>
  <p><strong>Rights mode:</strong> restricted private notes until a public-domain or otherwise usable reading copy is selected.</p>
  <p><strong>Use:</strong> Find the passages that make this text active inside poetry-and-judgment, education-and-civic-life, taste-and-standards.</p>
</section>

<section class="ah-passage-card">
  <span class="ah-action-kicker">Review Before Quoting</span>
  <h3>Layout, Notes, And Bibliography</h3>
  <p><strong>Review signal:</strong> multi_column_layout: 6<br>source_notes_detected: 6<br>transition_from_previous_author: 3</p>
...
| Field | Value |
| --- | --- |
| Text ID | `addison-spectator-essays` |
| Curated title | The Spectator, Nos. 62 and 412 |
| Creator | Joseph Addison |
| Thinker note | [Joseph Addison](../thinkers/joseph-addison.md) |
...
<li>Thinker: <a href="../../thinkers/joseph-addison/">Joseph Addison</a></li>
