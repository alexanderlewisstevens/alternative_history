# Matthew Arnold, Selected Critical Prose
...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> criticism, culture, education, public-life</span>
</div>
...
This note turns the current Norton chunk for Matthew Arnold into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.
...
| Field | Value |
| --- | --- |
| Text ID | `arnold-selected-critical-prose` |
| Curated title | Selected Critical Prose |
| Creator | Matthew Arnold |
| Thinker note | [Matthew Arnold](../thinkers/matthew-arnold.md) |
...
<li>Thinker: <a href="../../thinkers/matthew-arnold/">Matthew Arnold</a></li>
