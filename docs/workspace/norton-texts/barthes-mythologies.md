...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> myth, semiology, mass-culture, ideology</span>
</div>
...
<section class="ah-passage-card">
  ...
  <p><strong>Review pressure:</strong> 4 rows. mixed_work_transition_page: 4</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 1505-1508.</p>
  <p><strong>Rights mode:</strong> restricted private notes until a public-domain or otherwise usable reading copy is selected.</p>
  <p><strong>Use:</strong> Find the passages that make this text active inside vernacular-and-institution, media-and-form, labor-ideology-and-culture.</p>
</section>

<section class="ah-passage-card">
  <span class="ah-action-kicker">Review Before Quoting</span>
  <h3>Layout, Notes, And Bibliography</h3>
  <p><strong>Review signal:</strong> mixed_work_transition_page: 4</p>
...
| Field | Value |
| --- | --- |
| Text ID | `barthes-mythologies` |
| Curated title | Mythologies |
...
| Git commit | `525b073` |
| Script version | `3` |
| Output path | `docs/workspace/norton-texts/barthes-mythologies.md` |
