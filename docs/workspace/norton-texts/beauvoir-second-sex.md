...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> feminism, gender, myth, freedom</span>
</div>
...
This note turns the current Norton chunk for Simone de Beauvoir into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 1450-1458</h3>
  <p><strong>Page count:</strong> 9</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/simone-de-beauvoir.md</code></p>
  <p><strong>Page kinds:</strong> excerpt: 9</p>
  <p><strong>Review pressure:</strong> 9 rows. mixed_work_transition_page: 9</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 1450-1458.</p>
  <p><strong>Rights mode:</strong> restricted private notes until a public-domain or otherwise usable reading copy is selected.</p>
  <p><strong>Use:</strong> Find the passages that make this text active inside education-and-civic-life, aesthetic-education-and-citizenship, labor-ideology-and-culture.</p>
</section>

<section class="ah-passage-card">
  <span class="ah-action-kicker">Review Before Quoting</span>
  <h3>Layout, Notes, And Bibliography</h3>
  <p><strong>Review signal:</strong> mixed_work_transition_page: 9</p>
...
| Field | Value |
| --- | --- |
| Text ID | `beauvoir-second-sex` |
| Curated title | The Second Sex |
| Creator | Simone de Beauvoir |
| Thinker note | [Simone de Beauvoir](../thinkers/simone-de-beauvoir.md) |
| Register status | `edition-review-needed` |
| Source anthology | The Norton Anthology of Theory and Criticism |
| Source rights status | `copyrighted` |
| Restricted draft | `generated/authors/norton-theory-criticism/simone-de-beauvoir.md` |
| Workspace map | [Norton Workspace Map](../norton-map.md) |
| Generated at | `2026-06-13T07:13:46Z` |
| Git commit | `525b073` |
| Script version | `3` |
| Output path | `docs/workspace/norton-texts/beauvoir-second-sex.md` |
...
<li>Thinker: <a href="../../thinkers/simone-de-beauvoir/">Simone de Beauvoir</a></li>
