...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> psychoanalysis, desire, gender, signifier</span>
</div>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 1346-1354.</p>
  <p><strong>Rights mode:</strong> restricted private notes until a public-domain or otherwise usable reading copy is selected.</p>
  <p><strong>Use:</strong> Find the passages that make this text active inside language-truth-and-fiction.</p>
</section>
...
| Field | Value |
| --- | --- |
| Text ID | `lacan-signification-phallus` |
| Curated title | The Signification of the Phallus |
...
| Git commit | `525b073` |
| Script version | `3` |
| Output path | `docs/workspace/norton-texts/lacan-signification-phallus.md` |
