...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> poetry, common-life, language, imagination</span>
</div>
...
This note turns the current Norton chunk for William Wordsworth into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.
...
| Field | Value |
| --- | --- |
| Text ID | `wordsworth-lyrical-ballads-preface` |
| Curated title | Preface to Lyrical Ballads |
| Creator | William Wordsworth |
| Thinker note | [William Wordsworth](../thinkers/william-wordsworth.md) |
