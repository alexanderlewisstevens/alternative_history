...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> race, art, vernacular, cultural-politics</span>
</div>
...
This note turns the current Norton chunk for Langston Hughes into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 1357-1360</h3>
  <p><strong>Page count:</strong> 4</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/langston-hughes.md</code></p>
  <p><strong>Page kinds:</strong> excerpt: 3<br>author_intro: 1</p>
  <p><strong>Review pressure:</strong> 4 rows. mixed_work_transition_page: 3<br>mixed_bibliography_and_work_title: 1<br>transition_from_previous_author: 1</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 1357-1360.</p>
...
<section class="ah-passage-card">
  ...
  <p><strong>Review signal:</strong> mixed_work_transition_page: 3<br>mixed_bibliography_and_work_title: 1<br>transition_from_previous_author: 1</p>
...
| Field | Value |
| --- | --- |
| Text ID | `hughes-negro-artist-racial-mountain` |
| Curated title | The Negro Artist and the Racial Mountain |
| Creator | Langston Hughes |
| Thinker note | [Langston Hughes](../thinkers/langston-hughes.md) |
| Register status | `edition-review-needed` |
| Source anthology | The Norton Anthology of Theory and Criticism |
| Source rights status | `copyrighted` |
| Restricted draft | `generated/authors/norton-theory-criticism/langston-hughes.md` |
| Workspace map | [Norton Workspace Map](../norton-map.md) |
| Generated at | `2026-06-13T07:13:46Z` |
| Git commit | `525b073` |
| Script version | `3` |
| Output path | `docs/workspace/norton-texts/hughes-negro-artist-racial-mountain.md` |
...
<li>Thinker: <a href="../../thinkers/langston-hughes/">Langston Hughes</a></li>
