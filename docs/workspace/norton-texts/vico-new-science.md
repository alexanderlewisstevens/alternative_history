...
<section class="ah-passage-card">
  ...
  <p><strong>Page kinds:</strong> excerpt: 14<br>mixed_excerpt_bibliography: 1</p>
  <p><strong>Review pressure:</strong> 9 rows. multi_column_layout: 6<br>source_notes_detected: 6<br>mixed_excerpt_and_bibliography: 1<br>author_boundary_without_life_dates: 1</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 443-457.</p>
  <p><strong>Rights mode:</strong> restricted private notes until a public-domain or otherwise usable reading copy is selected.</p>
  <p><strong>Use:</strong> Find the passages that make this text active inside commentary-and-afterlife, education-and-civic-life, vernacular-and-institution, labor-ideology-and-culture.</p>
</section>

<section class="ah-passage-card">
  <span class="ah-action-kicker">Review Before Quoting</span>
  <h3>Layout, Notes, And Bibliography</h3>
  <p><strong>Review signal:</strong> multi_column_layout: 6<br>source_notes_detected: 6<br>mixed_excerpt_and_bibliography: 1<br>author_boundary_without_life_dates: 1</p>
