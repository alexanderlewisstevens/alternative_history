# Joachim du Bellay, The Defence and Illustration of the French Language
...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> vernacular, language, nation, imitation</span>
</div>
...
This note turns the current Norton chunk for Joachim du Bellay into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 323-332</h3>
  <p><strong>Page count:</strong> 10</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/joachim-du-bellay.md</code></p>
  <p><strong>Page kinds:</strong> excerpt: 9<br>author_intro: 1</p>
  <p><strong>Review pressure:</strong> 9 rows. multi_column_layout: 7<br>source_notes_detected: 7<br>transition_from_previous_author: 1<br>author_boundary_without_life_dates: 1</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 323-332.</p>
...
<section class="ah-passage-card">
  ...
  <p><strong>Review signal:</strong> multi_column_layout: 7<br>source_notes_detected: 7<br>transition_from_previous_author: 1<br>author_boundary_without_life_dates: 1</p>
...
| Field | Value |
| --- | --- |
| Text ID | `joachim-du-bellay-defense-french-language` |
| Curated title | The Defence and Illustration of the French Language |
| Creator | Joachim du Bellay |
| Thinker note | [Joachim du Bellay](../thinkers/joachim-du-bellay.md) |
...
<li>Thinker: <a href="../../thinkers/joachim-du-bellay/">Joachim du Bellay</a></li>
