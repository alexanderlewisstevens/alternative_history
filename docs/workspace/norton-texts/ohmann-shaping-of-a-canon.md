# Richard Ohmann, The Shaping of a Canon: U.S. Fiction, 1960-1975
...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> canon, publishing, institutions, class</span>
</div>
...
This note turns the current Norton chunk for Richard Ohmann into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 1924-1938</h3>
  <p><strong>Page count:</strong> 15</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/richard-ohmann.md</code></p>
  <p><strong>Page kinds:</strong> excerpt: 15</p>
  <p><strong>Review pressure:</strong> 15 rows. bibliography_on_previous_page: 15</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 1924-1938.</p>
  <p><strong>Rights mode:</strong> restricted private notes until a public-domain or otherwise usable reading copy is selected.</p>
  <p><strong>Use:</strong> Find the passages that make this text active inside signs-and-reading, commentary-and-afterlife, education-and-civic-life, authorship-and-authority, taste-and-standards, aesthetic-education-and-citizenship, art-utility-and-modern-life, labor-ideology-and-culture.</p>
</section>

<section class="ah-passage-card">
  <span class="ah-action-kicker">Review Before Quoting</span>
  <h3>Layout, Notes, And Bibliography</h3>
  <p><strong>Review signal:</strong> bibliography_on_previous_page: 15</p>
...
| Field | Value |
| --- | --- |
| Text ID | `ohmann-shaping-of-a-canon` |
| Curated title | The Shaping of a Canon: U.S. Fiction, 1960-1975 |
| Creator | Richard Ohmann |
| Thinker note | [Richard Ohmann](../thinkers/richard-ohmann.md) |
| Register status | `edition-review-needed` |
| Source anthology | The Norton Anthology of Theory and Criticism |
| Source rights status | `copyrighted` |
| Restricted draft | `generated/authors/norton-theory-criticism/richard-ohmann.md` |
| Workspace map | [Norton Workspace Map](../norton-map.md) |
| Generated at | `2026-06-13T07:13:47Z` |
| Git commit | `525b073` |
| Script version | `3` |
| Output path | `docs/workspace/norton-texts/ohmann-shaping-of-a-canon.md` |
...
<li>Thinker: <a href="../../thinkers/richard-ohmann/">Richard Ohmann</a></li>
