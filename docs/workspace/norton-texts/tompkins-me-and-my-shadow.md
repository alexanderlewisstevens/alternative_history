...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> feminist-criticism, personal-criticism, institutions, theory</span>
</div>
...
This note turns the current Norton chunk for Jane Tompkins into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 2173-2186</h3>
  <p><strong>Page count:</strong> 14</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/jane-tompkins.md</code></p>
  <p><strong>Page kinds:</strong> excerpt: 14</p>
  <p><strong>Review pressure:</strong> 14 rows. mixed_author_transition_page: 14<br>mixed_bibliography_and_work_title: 14</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 2173-2186.</p>
...
<section class="ah-passage-card">
  ...
  <p><strong>Review signal:</strong> mixed_author_transition_page: 14<br>mixed_bibliography_and_work_title: 14</p>
...
| Field | Value |
| --- | --- |
| Text ID | `tompkins-me-and-my-shadow` |
| Curated title | Me and My Shadow |
| Creator | Jane Tompkins |
| Thinker note | [Jane Tompkins](../thinkers/jane-tompkins.md) |
| Register status | `edition-review-needed` |
| Source anthology | The Norton Anthology of Theory and Criticism |
| Source rights status | `copyrighted` |
| Restricted draft | `generated/authors/norton-theory-criticism/jane-tompkins.md` |
| Workspace map | [Norton Workspace Map](../norton-map.md) |
| Generated at | `2026-06-13T07:03:57Z` |
| Git commit | `d472811` |
| Script version | `3` |
| Output path | `docs/workspace/norton-texts/tompkins-me-and-my-shadow.md` |
...
<li>Thinker: <a href="../../thinkers/jane-tompkins/">Jane Tompkins</a></li>
