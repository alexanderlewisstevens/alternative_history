...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> structuralism, narratology, poetics, method</span>
</div>
...
This note turns the current Norton chunk for Tzvetan Todorov into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 2143-2162</h3>
  <p><strong>Page count:</strong> 20</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/tzvetan-todorov.md</code></p>
  <p><strong>Page kinds:</strong> excerpt: 20</p>
  <p><strong>Review pressure:</strong> 20 rows. mixed_author_transition_page: 20<br>mixed_bibliography_and_work_title: 20</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 2143-2162.</p>
  <p><strong>Rights mode:</strong> restricted private notes until a public-domain or otherwise usable reading copy is selected.</p>
  <p><strong>Use:</strong> Find the passages that make this text active inside signs-and-reading, commentary-and-afterlife, vernacular-and-institution, language-truth-and-fiction.</p>
</section>

<section class="ah-passage-card">
  <span class="ah-action-kicker">Review Before Quoting</span>
  <h3>Layout, Notes, And Bibliography</h3>
  <p><strong>Review signal:</strong> mixed_author_transition_page: 20<br>mixed_bibliography_and_work_title: 20</p>
...
| Field | Value |
| --- | --- |
| Text ID | `todorov-structural-analysis-narrative` |
| Curated title | Structural Analysis of Narrative |
| Creator | Tzvetan Todorov |
| Thinker note | [Tzvetan Todorov](../thinkers/tzvetan-todorov.md) |
...
<li>Thinker: <a href="../../thinkers/tzvetan-todorov/">Tzvetan Todorov</a></li>
