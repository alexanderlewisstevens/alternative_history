...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> culture-industry, mass-culture, media, capitalism</span>
</div>
...
This note turns the current Norton chunk for Max Horkheimer and Theodor W. Adorno into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 1267-1283</h3>
  <p><strong>Page count:</strong> 17</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/max-horkheimer-and-theodor-w-adorno.md</code></p>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 1267-1283.</p>
  <p><strong>Rights mode:</strong> restricted private notes until a public-domain or otherwise usable reading copy is selected.</p>
  <p><strong>Use:</strong> Find the passages that make this text active inside media-and-form, labor-ideology-and-culture.</p>
</section>
...
| Field | Value |
| --- | --- |
| Text ID | `horkheimer-adorno-culture-industry` |
| Curated title | The Culture Industry: Enlightenment as Mass Deception |
| Creator | Max Horkheimer and Theodor W. Adorno |
| Thinker note | [Max Horkheimer and Theodor W. Adorno](../thinkers/max-horkheimer-and-theodor-w-adorno.md) |
| Register status | `edition-review-needed` |
| Source anthology | The Norton Anthology of Theory and Criticism |
| Source rights status | `copyrighted` |
| Restricted draft | `generated/authors/norton-theory-criticism/max-horkheimer-and-theodor-w-adorno.md` |
| Workspace map | [Norton Workspace Map](../norton-map.md) |
| Generated at | `2026-06-13T07:13:46Z` |
| Git commit | `525b073` |
| Script version | `3` |
| Output path | `docs/workspace/norton-texts/horkheimer-adorno-culture-industry.md` |
...
<li>Thinker: <a href="../../thinkers/max-horkheimer-and-theodor-w-adorno/">Max Horkheimer and Theodor W. Adorno</a></li>
