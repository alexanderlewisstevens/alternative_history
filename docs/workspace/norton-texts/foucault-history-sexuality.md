...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> sexuality, discourse, power, subject-formation</span>
</div>
...
This note turns the current Norton chunk for Michel Foucault into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 1692-1710</h3>
  <p><strong>Page count:</strong> 19</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/michel-foucault.md</code></p>
  <p><strong>Page kinds:</strong> excerpt: 19</p>
  <p><strong>Review pressure:</strong> 7 rows. multi_column_layout: 5<br>source_notes_detected: 4<br>author_boundary_without_life_dates: 1</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 1692-1710.</p>
  <p><strong>Rights mode:</strong> restricted private notes until a public-domain or otherwise usable reading copy is selected.</p>
  <p><strong>Use:</strong> Find the passages that make this text active inside vernacular-and-institution, labor-ideology-and-culture.</p>
</section>

<section class="ah-passage-card">
  <span class="ah-action-kicker">Review Before Quoting</span>
  <h3>Layout, Notes, And Bibliography</h3>
  <p><strong>Review signal:</strong> multi_column_layout: 5<br>source_notes_detected: 4<br>author_boundary_without_life_dates: 1</p>
...
| Field | Value |
| --- | --- |
| Text ID | `foucault-history-sexuality` |
| Curated title | The History of Sexuality |
| Creator | Michel Foucault |
| Thinker note | [Michel Foucault](../thinkers/michel-foucault.md) |
...
| Git commit | `e688291` |
| Script version | `3` |
| Output path | `docs/workspace/norton-texts/foucault-history-sexuality.md` |
...
<li>Thinker: <a href="../../thinkers/michel-foucault/">Michel Foucault</a></li>
