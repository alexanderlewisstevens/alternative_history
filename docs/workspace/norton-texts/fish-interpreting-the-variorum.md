...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> reader-response, interpretation, institutions, pragmatism</span>
</div>
...
This note turns the current Norton chunk for Stanley E. Fish into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.
...
| Field | Value |
| --- | --- |
| Text ID | `fish-interpreting-the-variorum` |
| Curated title | Interpreting the Variorum |
| Creator | Stanley E. Fish |
| Thinker note | [Stanley E. Fish](../thinkers/stanley-e-fish.md) |
...
<li>Thinker: <a href="../../thinkers/stanley-e-fish/">Stanley E. Fish</a></li>
