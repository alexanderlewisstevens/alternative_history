...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> formalism, literary-theory, method, technique</span>
</div>
...
This note turns the current Norton chunk for Boris Eichenbaum into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 1106-1131</h3>
  <p><strong>Page count:</strong> 26</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/boris-eichenbaum.md</code></p>
  <p><strong>Page kinds:</strong> excerpt: 26</p>
  <p><strong>Review pressure:</strong> 18 rows. source_notes_detected: 14<br>multi_column_layout: 12<br>mixed_bibliography_and_work_title: 1<br>mixed_transition_page: 1<br>transition_from_previous_author: 1</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 1106-1131.</p>
  <p><strong>Rights mode:</strong> restricted private notes until a public-domain or otherwise usable reading copy is selected.</p>
  <p><strong>Use:</strong> Find the passages that make this text active inside poetry-and-judgment, signs-and-reading, commentary-and-afterlife, media-and-form, labor-ideology-and-culture, language-truth-and-fiction.</p>
</section>

<section class="ah-passage-card">
  <span class="ah-action-kicker">Review Before Quoting</span>
  <h3>Layout, Notes, And Bibliography</h3>
  <p><strong>Review signal:</strong> source_notes_detected: 14<br>multi_column_layout: 12<br>mixed_bibliography_and_work_title: 1<br>mixed_transition_page: 1<br>transition_from_previous_author: 1</p>
...
| Field | Value |
| --- | --- |
| Text ID | `eichenbaum-theory-formal-method` |
| Curated title | The Theory of the Formal Method |
| Creator | Boris Eichenbaum |
| Thinker note | [Boris Eichenbaum](../thinkers/boris-eichenbaum.md) |
| Register status | `edition-review-needed` |
| Source anthology | The Norton Anthology of Theory and Criticism |
| Source rights status | `copyrighted` |
| Restricted draft | `generated/authors/norton-theory-criticism/boris-eichenbaum.md` |
| Workspace map | [Norton Workspace Map](../norton-map.md) |
| Generated at | `2026-06-13T07:13:46Z` |
| Git commit | `525b073` |
| Script version | `3` |
| Output path | `docs/workspace/norton-texts/eichenbaum-theory-formal-method.md` |
...
<li>Thinker: <a href="../../thinkers/boris-eichenbaum/">Boris Eichenbaum</a></li>
