...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> disability-studies, normalcy, body, labor</span>
</div>
...
This note turns the current Norton chunk for Lennard J. Davis into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.
...
| Field | Value |
| --- | --- |
| Text ID | `davis-enforcing-normalcy` |
| Curated title | Enforcing Normalcy: Disability, Deafness, and the Body |
| Creator | Lennard J. Davis |
| Thinker note | [Lennard J. Davis](../thinkers/lennard-j-davis.md) |
...
<li>Thinker: <a href="../../thinkers/lennard-j-davis/">Lennard J. Davis</a></li>
