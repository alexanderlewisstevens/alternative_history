# Samuel Johnson, Selected Critical Prose
...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> fiction, shakespeare, criticism, public-judgment</span>
</div>
...
This note turns the current Norton chunk for Samuel Johnson into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 500-524</h3>
  <p><strong>Page count:</strong> 25</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/samuel-johnson.md</code></p>
  <p><strong>Page kinds:</strong> excerpt: 18<br>author_intro: 7</p>
  <p><strong>Review pressure:</strong> 21 rows. multi_column_layout: 9<br>source_notes_detected: 9<br>transition_from_previous_author: 7</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 500-524.</p>
  <p><strong>Rights mode:</strong> restricted private notes until a public-domain or otherwise usable reading copy is selected.</p>
  <p><strong>Use:</strong> Find the passages that make this text active inside poetry-and-judgment, education-and-civic-life, theater-and-public-judgment, authorship-and-authority, taste-and-standards.</p>
</section>

<section class="ah-passage-card">
  <span class="ah-action-kicker">Review Before Quoting</span>
  <h3>Layout, Notes, And Bibliography</h3>
  <p><strong>Review signal:</strong> multi_column_layout: 9<br>source_notes_detected: 9<br>transition_from_previous_author: 7</p>
...
| Field | Value |
| --- | --- |
| Text ID | `johnson-selected-critical-prose` |
| Curated title | Selected Critical Prose |
| Creator | Samuel Johnson |
| Thinker note | [Samuel Johnson](../thinkers/samuel-johnson.md) |
| Register status | `edition-review-needed` |
| Source anthology | The Norton Anthology of Theory and Criticism |
| Source rights status | `copyrighted` |
| Restricted draft | `generated/authors/norton-theory-criticism/samuel-johnson.md` |
| Workspace map | [Norton Workspace Map](../norton-map.md) |
| Generated at | `2026-06-13T06:32:03Z` |
| Git commit | `90b00be` |
| Script version | `3` |
| Output path | `docs/workspace/norton-texts/johnson-selected-critical-prose.md` |
...
<li>Thinker: <a href="../../thinkers/samuel-johnson/">Samuel Johnson</a></li>
