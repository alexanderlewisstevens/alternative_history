...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> aesthetic-education, freedom, play, citizenship</span>
</div>
...
This note turns the current Norton chunk for Friedrich Schiller into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 613-623</h3>
  <p><strong>Page count:</strong> 11</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/friedrich-schiller.md</code></p>
  <p><strong>Page kinds:</strong> excerpt: 9<br>author_intro: 2</p>
  <p><strong>Review pressure:</strong> 10 rows. source_notes_detected: 7<br>transition_from_previous_author: 2<br>multi_column_layout: 1</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 613-623.</p>
  <p><strong>Rights mode:</strong> restricted private notes until a public-domain or otherwise usable reading copy is selected.</p>
  <p><strong>Use:</strong> Find the passages that make this text active inside poetry-and-judgment, beauty-and-ascent, education-and-civic-life, taste-and-standards, aesthetic-education-and-citizenship.</p>
</section>

<section class="ah-passage-card">
  <span class="ah-action-kicker">Review Before Quoting</span>
  <h3>Layout, Notes, And Bibliography</h3>
  <p><strong>Review signal:</strong> source_notes_detected: 7<br>transition_from_previous_author: 2<br>multi_column_layout: 1</p>
...
| Field | Value |
| --- | --- |
| Text ID | `schiller-aesthetic-education` |
| Curated title | On the Aesthetic Education of Man |
| Creator | Friedrich Schiller |
| Thinker note | [Friedrich Schiller](../thinkers/friedrich-schiller.md) |
...
<li>Thinker: <a href="../../thinkers/friedrich-schiller/">Friedrich Schiller</a></li>
