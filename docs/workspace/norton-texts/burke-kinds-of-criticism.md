...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> rhetoric, criticism, method, symbolic-action</span>
</div>
...
This note turns the current Norton chunk for Kenneth Burke into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 1316-1321</h3>
  <p><strong>Page count:</strong> 6</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/kenneth-burke.md</code></p>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 1316-1321.</p>
  <p><strong>Rights mode:</strong> restricted private notes until a public-domain or otherwise usable reading copy is selected.</p>
  <p><strong>Use:</strong> Find the passages that make this text active inside commentary-and-afterlife, education-and-civic-life, authorship-and-authority, taste-and-standards, language-truth-and-fiction.</p>
</section>
...
| Field | Value |
| --- | --- |
| Text ID | `burke-kinds-of-criticism` |
| Curated title | Kinds of Criticism |
| Creator | Kenneth Burke |
| Thinker note | [Kenneth Burke](../thinkers/kenneth-burke.md) |
...
<li>Thinker: <a href="../../thinkers/kenneth-burke/">Kenneth Burke</a></li>
