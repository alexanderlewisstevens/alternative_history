...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> lesbian-feminism, feminist-criticism, canon, identity</span>
</div>
...
This note turns the current Norton chunk for Bonnie Zimmerman into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 2384-2403</h3>
  <p><strong>Page count:</strong> 20</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/bonnie-zimmerman.md</code></p>
  <p><strong>Page kinds:</strong> excerpt: 20</p>
  <p><strong>Review pressure:</strong> 20 rows. mixed_bibliography_and_work_title: 20</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 2384-2403.</p>
  <p><strong>Rights mode:</strong> restricted private notes until a public-domain or otherwise usable reading copy is selected.</p>
  <p><strong>Use:</strong> Find the passages that make this text active inside signs-and-reading, education-and-civic-life, authorship-and-authority, taste-and-standards, aesthetic-education-and-citizenship.</p>
</section>

<section class="ah-passage-card">
  <span class="ah-action-kicker">Review Before Quoting</span>
  <h3>Layout, Notes, And Bibliography</h3>
  <p><strong>Review signal:</strong> mixed_bibliography_and_work_title: 20</p>
...
| Field | Value |
| --- | --- |
| Text ID | `zimmerman-what-has-never-been` |
| Curated title | What Has Never Been: An Overview of Lesbian Feminist Literary Criticism |
| Creator | Bonnie Zimmerman |
| Thinker note | [Bonnie Zimmerman](../thinkers/bonnie-zimmerman.md) |
| Register status | `edition-review-needed` |
| Source anthology | The Norton Anthology of Theory and Criticism |
| Source rights status | `copyrighted` |
| Restricted draft | `generated/authors/norton-theory-criticism/bonnie-zimmerman.md` |
| Workspace map | [Norton Workspace Map](../norton-map.md) |
| Generated at | `2026-06-13T16:48:41Z` |
| Git commit | `493d797` |
| Script version | `3` |
| Output path | `docs/workspace/norton-texts/zimmerman-what-has-never-been.md` |
...
<li>Thinker: <a href="../../thinkers/bonnie-zimmerman/">Bonnie Zimmerman</a></li>
