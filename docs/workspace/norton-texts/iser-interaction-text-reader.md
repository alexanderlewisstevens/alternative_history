...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> reader-response, interpretation, gaps, communication</span>
</div>
...
This note turns the current Norton chunk for Wolfgang Iser into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 1717-1725</h3>
  <p><strong>Page count:</strong> 9</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/wolfgang-iser.md</code></p>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 1717-1725.</p>
  <p><strong>Rights mode:</strong> restricted private notes until a public-domain or otherwise usable reading copy is selected.</p>
  <p><strong>Use:</strong> Find the passages that make this text active inside signs-and-reading, commentary-and-afterlife, education-and-civic-life, authorship-and-authority, taste-and-standards, media-and-form, aesthetic-education-and-citizenship, language-truth-and-fiction.</p>
</section>
...
| Field | Value |
| --- | --- |
| Text ID | `iser-interaction-text-reader` |
| Curated title | Interaction Between Text and Reader |
| Creator | Wolfgang Iser |
| Thinker note | [Wolfgang Iser](../thinkers/wolfgang-iser.md) |
...
<li>Thinker: <a href="../../thinkers/wolfgang-iser/">Wolfgang Iser</a></li>
