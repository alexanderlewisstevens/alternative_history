...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> simulation, signs, media, hyperreality</span>
</div>
...
This note turns the current Norton chunk for Jean Baudrillard into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 1776-1784</h3>
  <p><strong>Page count:</strong> 9</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/jean-baudrillard.md</code></p>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 1776-1784.</p>
...
| Field | Value |
| --- | --- |
| Text ID | `baudrillard-precession-simulacra` |
| Curated title | The Precession of Simulacra |
| Creator | Jean Baudrillard |
| Thinker note | [Jean Baudrillard](../thinkers/jean-baudrillard.md) |
...
<li>Thinker: <a href="../../thinkers/jean-baudrillard/">Jean Baudrillard</a></li>
