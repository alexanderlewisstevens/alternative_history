# Georg Wilhelm Friedrich Hegel, Phenomenology of Spirit and Lectures on Fine Art
...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> spirit, aesthetics, history, recognition</span>
</div>
...
This note turns the current Norton chunk for Georg Wilhelm Friedrich Hegel into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 668-686</h3>
  <p><strong>Page count:</strong> 19</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/georg-wilhelm-friedrich-hegel.md</code></p>
  <p><strong>Page kinds:</strong> excerpt: 14<br>author_intro: 5</p>
  <p><strong>Review pressure:</strong> 6 rows. transition_from_previous_author: 5<br>source_notes_detected: 1</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 668-686.</p>
  <p><strong>Rights mode:</strong> restricted private notes until a public-domain or otherwise usable reading copy is selected.</p>
  <p><strong>Use:</strong> Find the passages that make this text active inside signs-and-reading, beauty-and-ascent, commentary-and-afterlife, sublime-and-limits.</p>
</section>

<section class="ah-passage-card">
  <span class="ah-action-kicker">Review Before Quoting</span>
  <h3>Layout, Notes, And Bibliography</h3>
  <p><strong>Review signal:</strong> transition_from_previous_author: 5<br>source_notes_detected: 1</p>
...
| Field | Value |
| --- | --- |
| Text ID | `hegel-phenomenology-fine-art` |
| Curated title | Phenomenology of Spirit and Lectures on Fine Art |
| Creator | Georg Wilhelm Friedrich Hegel |
| Thinker note | [Georg Wilhelm Friedrich Hegel](../thinkers/georg-wilhelm-friedrich-hegel.md) |
...
<li>Thinker: <a href="../../thinkers/georg-wilhelm-friedrich-hegel/">Georg Wilhelm Friedrich Hegel</a></li>
