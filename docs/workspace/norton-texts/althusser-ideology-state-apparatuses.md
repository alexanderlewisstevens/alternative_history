...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> ideology, education, state, reproduction</span>
</div>
...
This note turns the current Norton chunk for Louis Althusser into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 1527-1551</h3>
  <p><strong>Page count:</strong> 25</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/louis-althusser.md</code></p>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 1527-1551.</p>
  <p><strong>Rights mode:</strong> restricted private notes until a public-domain or otherwise usable reading copy is selected.</p>
  <p><strong>Use:</strong> Find the passages that make this text active inside education-and-civic-life, vernacular-and-institution, aesthetic-education-and-citizenship, labor-ideology-and-culture.</p>
</section>
...
| Field | Value |
| --- | --- |
| Text ID | `althusser-ideology-state-apparatuses` |
| Curated title | Ideology and Ideological State Apparatuses |
| Creator | Louis Althusser |
| Thinker note | [Louis Althusser](../thinkers/louis-althusser.md) |
...
| Git commit | `525b073` |
| Script version | `3` |
| Output path | `docs/workspace/norton-texts/althusser-ideology-state-apparatuses.md` |
...
<li>Thinker: <a href="../../thinkers/louis-althusser/">Louis Althusser</a></li>
