...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> realism, marxism, modernism, totality</span>
</div>
...
This note turns the current Norton chunk for Gyorgy Lukacs into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.
...
| Field | Value |
| --- | --- |
| Text ID | `lukacs-realism-in-the-balance` |
| Curated title | Realism in the Balance |
| Creator | Gyorgy Lukacs |
| Thinker note | [Gyorgy Lukacs](../thinkers/gyorgy-lukacs.md) |
...
<li>Thinker: <a href="../../thinkers/gyorgy-lukacs/">Gyorgy Lukacs</a></li>
