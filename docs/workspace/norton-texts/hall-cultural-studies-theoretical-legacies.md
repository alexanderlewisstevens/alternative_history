...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> cultural-studies, hegemony, politics, intellectual-work</span>
</div>
...
This note turns the current Norton chunk for Stuart Hall into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 1942-1953</h3>
  <p><strong>Page count:</strong> 12</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/stuart-hall.md</code></p>
  <p><strong>Page kinds:</strong> excerpt: 12</p>
  <p><strong>Review pressure:</strong> 12 rows. mixed_author_transition_page: 12<br>mixed_bibliography_and_work_title: 12</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 1942-1953.</p>
  <p><strong>Rights mode:</strong> restricted private notes until a public-domain or otherwise usable reading copy is selected.</p>
  <p><strong>Use:</strong> Find the passages that make this text active inside commentary-and-afterlife, education-and-civic-life, aesthetic-education-and-citizenship, art-utility-and-modern-life, labor-ideology-and-culture, language-truth-and-fiction.</p>
</section>

<section class="ah-passage-card">
  <span class="ah-action-kicker">Review Before Quoting</span>
  <h3>Layout, Notes, And Bibliography</h3>
  <p><strong>Review signal:</strong> mixed_author_transition_page: 12<br>mixed_bibliography_and_work_title: 12</p>
...
| Field | Value |
| --- | --- |
| Text ID | `hall-cultural-studies-theoretical-legacies` |
| Curated title | Cultural Studies and Its Theoretical Legacies |
| Creator | Stuart Hall |
| Thinker note | [Stuart Hall](../thinkers/stuart-hall.md) |
| Register status | `edition-review-needed` |
| Source anthology | The Norton Anthology of Theory and Criticism |
| Source rights status | `copyrighted` |
| Restricted draft | `generated/authors/norton-theory-criticism/stuart-hall.md` |
| Workspace map | [Norton Workspace Map](../norton-map.md) |
| Generated at | `2026-06-13T06:43:25Z` |
| Git commit | `1be04e7` |
| Script version | `3` |
| Output path | `docs/workspace/norton-texts/hall-cultural-studies-theoretical-legacies.md` |
...
<li>Thinker: <a href="../../thinkers/stuart-hall/">Stuart Hall</a></li>
