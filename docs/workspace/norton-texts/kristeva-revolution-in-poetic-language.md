...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> semiotics, psychoanalysis, subjectivity, avant-garde</span>
</div>
...
This note turns the current Norton chunk for Julia Kristeva into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 2213-2222</h3>
  <p><strong>Page count:</strong> 10</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/julia-kristeva.md</code></p>
  <p><strong>Page kinds:</strong> excerpt: 10</p>
  <p><strong>Review pressure:</strong> 10 rows. mixed_author_transition_page: 10<br>mixed_bibliography_and_work_title: 10</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 2213-2222.</p>
...
<section class="ah-passage-card">
  ...
  <p><strong>Review signal:</strong> mixed_author_transition_page: 10<br>mixed_bibliography_and_work_title: 10</p>
...
| Field | Value |
| --- | --- |
| Text ID | `kristeva-revolution-in-poetic-language` |
| Curated title | Revolution in Poetic Language |
| Creator | Julia Kristeva |
| Thinker note | [Julia Kristeva](../thinkers/julia-kristeva.md) |
| Register status | `edition-review-needed` |
| Source anthology | The Norton Anthology of Theory and Criticism |
| Source rights status | `copyrighted` |
| Restricted draft | `generated/authors/norton-theory-criticism/julia-kristeva.md` |
| Workspace map | [Norton Workspace Map](../norton-map.md) |
| Generated at | `2026-06-13T07:19:07Z` |
| Git commit | `e8608c4` |
| Script version | `3` |
| Output path | `docs/workspace/norton-texts/kristeva-revolution-in-poetic-language.md` |
...
<li>Thinker: <a href="../../thinkers/julia-kristeva/">Julia Kristeva</a></li>
