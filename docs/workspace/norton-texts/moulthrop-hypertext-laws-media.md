...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> hypertext, media-theory, digital-culture, literacy</span>
</div>
...
This note turns the current Norton chunk for Stuart Moulthrop into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 2548-2568</h3>
  <p><strong>Page count:</strong> 21</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/stuart-moulthrop.md</code></p>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 2548-2568.</p>
  <p><strong>Rights mode:</strong> restricted private notes until a public-domain or otherwise usable reading copy is selected.</p>
  <p><strong>Use:</strong> Find the passages that make this text active inside signs-and-reading, commentary-and-afterlife, education-and-civic-life, media-and-form, aesthetic-education-and-citizenship, labor-ideology-and-culture, language-truth-and-fiction.</p>
</section>
...
| Field | Value |
| --- | --- |
| Text ID | `moulthrop-hypertext-laws-media` |
| Curated title | You Say You Want a Revolution? Hypertext and the Laws of Media |
| Creator | Stuart Moulthrop |
| Thinker note | [Stuart Moulthrop](../thinkers/stuart-moulthrop.md) |
| Register status | `edition-review-needed` |
| Source anthology | The Norton Anthology of Theory and Criticism |
| Source rights status | `copyrighted` |
| Restricted draft | `generated/authors/norton-theory-criticism/stuart-moulthrop.md` |
| Workspace map | [Norton Workspace Map](../norton-map.md) |
| Generated at | `2026-06-13T16:48:42Z` |
| Git commit | `493d797` |
| Script version | `3` |
| Output path | `docs/workspace/norton-texts/moulthrop-hypertext-laws-media.md` |
...
<li>Thinker: <a href="../../thinkers/stuart-moulthrop/">Stuart Moulthrop</a></li>
