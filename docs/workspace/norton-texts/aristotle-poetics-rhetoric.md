...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> poetics, rhetoric, genre, audience</span>
</div>
...
This note turns the current Norton chunk for Aristotle into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 128-162</h3>
  <p><strong>Page count:</strong> 35</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/aristotle.md</code></p>
  <p><strong>Page kinds:</strong> excerpt: 30<br>author_intro: 5</p>
  <p><strong>Review pressure:</strong> 23 rows. multi_column_layout: 21<br>source_notes_detected: 15<br>transition_from_previous_work: 2<br>author_boundary_without_life_dates: 1</p>
</section>
...
- Poetics
- Rhetoric, Book I, Chapter 2
- Rhetoric, Book II, Chapter 1
...
<section class="ah-passage-card">
  ...
  <p><strong>Use:</strong> Find the passages that make this text active inside rhetoric-and-force, poetry-and-judgment.</p>
</section>

<section class="ah-passage-card">
  <span class="ah-action-kicker">Review Before Quoting</span>
  <h3>Layout, Notes, And Bibliography</h3>
  <p><strong>Review signal:</strong> multi_column_layout: 21<br>source_notes_detected: 15<br>transition_from_previous_work: 2<br>author_boundary_without_life_dates: 1</p>
...
| Field | Value |
| --- | --- |
| Text ID | `aristotle-poetics-rhetoric` |
| Curated title | Poetics and Rhetoric |
| Creator | Aristotle |
| Thinker note | [Aristotle](../thinkers/aristotle.md) |
