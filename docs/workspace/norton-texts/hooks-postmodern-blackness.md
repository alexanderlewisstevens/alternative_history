...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> black-feminism, postmodernism, identity, public-intellectuals</span>
</div>
...
This note turns the current Norton chunk for bell hooks into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.
...
| Field | Value |
| --- | --- |
| Text ID | `hooks-postmodern-blackness` |
| Curated title | Postmodern Blackness |
| Creator | bell hooks |
| Thinker note | [bell hooks](../thinkers/bell-hooks.md) |
...
<li>Thinker: <a href="../../thinkers/bell-hooks/">bell hooks</a></li>
