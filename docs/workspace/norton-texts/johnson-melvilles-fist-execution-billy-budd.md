# Barbara Johnson, Melville&#x27;s Fist: The Execution of Billy Budd
...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> deconstruction, law, language, pedagogy</span>
</div>
...
This note turns the current Norton chunk for Barbara Johnson into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 2363-2367</h3>
  <p><strong>Page count:</strong> 5</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/barbara-johnson.md</code></p>
  <p><strong>Page kinds:</strong> excerpt: 5</p>
  <p><strong>Review pressure:</strong> 5 rows. continues_beyond_current_batch: 5<br>mixed_bibliography_and_work_title: 5</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 2363-2367.</p>
...
<section class="ah-passage-card">
  ...
  <p><strong>Review signal:</strong> continues_beyond_current_batch: 5<br>mixed_bibliography_and_work_title: 5</p>
...
| Field | Value |
| --- | --- |
| Text ID | `johnson-melvilles-fist-execution-billy-budd` |
| Curated title | Melville&#x27;s Fist: The Execution of Billy Budd |
| Creator | Barbara Johnson |
| Thinker note | [Barbara Johnson](../thinkers/barbara-johnson.md) |
| Register status | `edition-review-needed` |
| Source anthology | The Norton Anthology of Theory and Criticism |
| Source rights status | `copyrighted` |
| Restricted draft | `generated/authors/norton-theory-criticism/barbara-johnson.md` |
| Workspace map | [Norton Workspace Map](../norton-map.md) |
| Generated at | `2026-06-13T07:03:57Z` |
| Git commit | `d472811` |
| Script version | `3` |
| Output path | `docs/workspace/norton-texts/johnson-melvilles-fist-execution-billy-budd.md` |
...
<li>Thinker: <a href="../../thinkers/barbara-johnson/">Barbara Johnson</a></li>
