...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> dialogism, heteroglossia, novel, language</span>
</div>
...
This note turns the current Norton chunk for Mikhail M. Bakhtin into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.
...
| Field | Value |
| --- | --- |
| Text ID | `bakhtin-discourse-in-the-novel` |
| Curated title | Discourse in the Novel |
| Creator | Mikhail M. Bakhtin |
| Thinker note | [Mikhail M. Bakhtin](../thinkers/mikhail-bakhtin.md) |
...
<li>Thinker: <a href="../../thinkers/mikhail-bakhtin/">Mikhail M. Bakhtin</a></li>
