...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> originality, imitation, authorship, genius</span>
</div>
...
This note turns the current Norton chunk for Edward Young into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 468-479</h3>
  <p><strong>Page count:</strong> 12</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/edward-young.md</code></p>
  <p><strong>Page kinds:</strong> excerpt: 10<br>author_intro: 1<br>mixed_excerpt_bibliography: 1</p>
  <p><strong>Review pressure:</strong> 11 rows. source_notes_detected: 9<br>multi_column_layout: 8<br>transition_from_previous_author: 1<br>mixed_excerpt_and_bibliography: 1</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 468-479.</p>
  <p><strong>Rights mode:</strong> restricted private notes until a public-domain or otherwise usable reading copy is selected.</p>
  <p><strong>Use:</strong> Find the passages that make this text active inside poetry-and-judgment, authorship-and-authority.</p>
</section>

<section class="ah-passage-card">
  <span class="ah-action-kicker">Review Before Quoting</span>
  <h3>Layout, Notes, And Bibliography</h3>
  <p><strong>Review signal:</strong> source_notes_detected: 9<br>multi_column_layout: 8<br>transition_from_previous_author: 1<br>mixed_excerpt_and_bibliography: 1</p>
...
| Field | Value |
| --- | --- |
| Text ID | `young-conjectures-original-composition` |
| Curated title | Conjectures on Original Composition |
| Creator | Edward Young |
| Thinker note | [Edward Young](../thinkers/edward-young.md) |
| Register status | `edition-review-needed` |
| Source anthology | The Norton Anthology of Theory and Criticism |
| Source rights status | `copyrighted` |
| Restricted draft | `generated/authors/norton-theory-criticism/edward-young.md` |
| Workspace map | [Norton Workspace Map](../norton-map.md) |
| Generated at | `2026-06-13T04:36:20Z` |
| Git commit | `647245f` |
| Script version | `2` |
| Output path | `docs/workspace/norton-texts/young-conjectures-original-composition.md` |
...
<li>Thinker: <a href="../../thinkers/edward-young/">Edward Young</a></li>
