...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> aestheticism, perception, criticism, experience</span>
</div>
...
This note turns the current Norton chunk for Walter Pater into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.
...
| Field | Value |
| --- | --- |
| Text ID | `pater-renaissance` |
| Curated title | Studies in the History of the Renaissance |
| Creator | Walter Pater |
| Thinker note | [Walter Pater](../thinkers/walter-pater.md) |
...
<li>Thinker: <a href="../../thinkers/walter-pater/">Walter Pater</a></li>
