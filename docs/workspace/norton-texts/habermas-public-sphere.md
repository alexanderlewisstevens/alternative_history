...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> public-sphere, citizenship, reason, institutions</span>
</div>
...
This note turns the current Norton chunk for Jurgen Habermas into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 1788-1792</h3>
  <p><strong>Page count:</strong> 5</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/jurgen-habermas.md</code></p>
  <p><strong>Page kinds:</strong> excerpt: 5</p>
  <p><strong>Review pressure:</strong> 5 rows. mixed_bibliography_and_work_title: 5<br>selection_boundary_review: 5</p>
</section>

## Works And Excerpt Blocks

- The Structural Transformation of the Public Sphere
- From The Structural Transformation of the Public Sphere
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 1788-1792.</p>
  <p><strong>Rights mode:</strong> restricted private notes until a public-domain or otherwise usable reading copy is selected.</p>
  <p><strong>Use:</strong> Find the passages that make this text active inside commentary-and-afterlife, education-and-civic-life, vernacular-and-institution, aesthetic-education-and-citizenship, labor-ideology-and-culture, language-truth-and-fiction.</p>
</section>

<section class="ah-passage-card">
  <span class="ah-action-kicker">Review Before Quoting</span>
  <h3>Layout, Notes, And Bibliography</h3>
  <p><strong>Review signal:</strong> mixed_bibliography_and_work_title: 5<br>selection_boundary_review: 5</p>
...
| Field | Value |
| --- | --- |
| Text ID | `habermas-public-sphere` |
| Curated title | The Structural Transformation of the Public Sphere |
| Creator | Jurgen Habermas |
| Thinker note | [Jurgen Habermas](../thinkers/jurgen-habermas.md) |
| Register status | `edition-review-needed` |
| Source anthology | The Norton Anthology of Theory and Criticism |
| Source rights status | `copyrighted` |
| Restricted draft | `generated/authors/norton-theory-criticism/jurgen-habermas.md` |
| Workspace map | [Norton Workspace Map](../norton-map.md) |
| Generated at | `2026-06-13T06:21:53Z` |
| Git commit | `37412ef` |
| Script version | `3` |
| Output path | `docs/workspace/norton-texts/habermas-public-sphere.md` |
...
<li>Thinker: <a href="../../thinkers/jurgen-habermas/">Jurgen Habermas</a></li>
