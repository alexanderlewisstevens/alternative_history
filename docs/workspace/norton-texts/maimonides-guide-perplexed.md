...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> allegory, reason, revelation, interpretation</span>
</div>
...
This note turns the current Norton chunk for Moses Maimonides into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 256-267</h3>
  <p><strong>Page count:</strong> 12</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/moses-maimonides.md</code></p>
  <p><strong>Page kinds:</strong> excerpt: 11<br>author_intro: 1</p>
  <p><strong>Review pressure:</strong> 12 rows. source_notes_detected: 10<br>multi_column_layout: 8<br>transition_from_previous_author: 1</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 256-267.</p>
...
<section class="ah-passage-card">
  ...
  <p><strong>Review signal:</strong> source_notes_detected: 10<br>multi_column_layout: 8<br>transition_from_previous_author: 1</p>
...
| Field | Value |
| --- | --- |
| Text ID | `maimonides-guide-perplexed` |
| Curated title | The Guide of the Perplexed |
| Creator | Moses Maimonides |
| Thinker note | [Moses Maimonides](../thinkers/moses-maimonides.md) |
...
<li>Thinker: <a href="../../thinkers/moses-maimonides/">Moses Maimonides</a></li>
