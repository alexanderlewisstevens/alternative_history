...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> art, ideology, marxism, aesthetics</span>
</div>
...
<section class="ah-passage-card">
  ...
  <p><strong>Review pressure:</strong> 3 rows. mixed_work_transition_page: 3</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 1524-1526.</p>
...
<section class="ah-passage-card">
  ...
  <p><strong>Review signal:</strong> mixed_work_transition_page: 3</p>
...
| Field | Value |
| --- | --- |
| Text ID | `althusser-letter-on-art` |
| Curated title | A Letter on Art in Reply to Andre Daspre |
