...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> rhizome, multiplicity, mapping, poststructuralism</span>
</div>
...
<section class="ah-passage-card">
  ...
  <p><strong>Review pressure:</strong> 3 rows. continues_beyond_current_batch: 3<br>mixed_work_transition_page: 3</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 1645-1647.</p>
  <p><strong>Rights mode:</strong> restricted private notes until a public-domain or otherwise usable reading copy is selected.</p>
  <p><strong>Use:</strong> Find the passages that make this text active inside signs-and-reading, media-and-form, language-truth-and-fiction.</p>
</section>

<section class="ah-passage-card">
  <span class="ah-action-kicker">Review Before Quoting</span>
  <h3>Layout, Notes, And Bibliography</h3>
  <p><strong>Review signal:</strong> continues_beyond_current_batch: 3<br>mixed_work_transition_page: 3</p>
...
| Field | Value |
| --- | --- |
| Text ID | `deleuze-guattari-thousand-plateaus` |
| Curated title | A Thousand Plateaus |
...
| Git commit | `e71f735` |
| Script version | `2` |
| Output path | `docs/workspace/norton-texts/deleuze-guattari-thousand-plateaus.md` |
