...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> postmodernism, modernity, sublime, progress</span>
</div>
...
This note turns the current Norton chunk for Jean-Francois Lyotard into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 1656-1658</h3>
  <p><strong>Page count:</strong> 3</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/jean-francois-lyotard.md</code></p>
  <p><strong>Page kinds:</strong> excerpt: 3</p>
  <p><strong>Review pressure:</strong> 3 rows. mixed_author_transition_page: 3<br>mixed_bibliography_and_work_title: 3</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 1656-1658.</p>
  <p><strong>Rights mode:</strong> restricted private notes until a public-domain or otherwise usable reading copy is selected.</p>
  <p><strong>Use:</strong> Find the passages that make this text active inside signs-and-reading, taste-and-standards, media-and-form, aesthetic-education-and-citizenship, language-truth-and-fiction.</p>
</section>

<section class="ah-passage-card">
  <span class="ah-action-kicker">Review Before Quoting</span>
  <h3>Layout, Notes, And Bibliography</h3>
  <p><strong>Review signal:</strong> mixed_author_transition_page: 3<br>mixed_bibliography_and_work_title: 3</p>
...
| Field | Value |
| --- | --- |
| Text ID | `lyotard-defining-postmodern` |
| Curated title | Defining the Postmodern |
| Creator | Jean-Francois Lyotard |
| Thinker note | [Jean-Francois Lyotard](../thinkers/jean-francois-lyotard.md) |
| Register status | `edition-review-needed` |
| Source anthology | The Norton Anthology of Theory and Criticism |
| Source rights status | `copyrighted` |
| Restricted draft | `generated/authors/norton-theory-criticism/jean-francois-lyotard.md` |
| Workspace map | [Norton Workspace Map](../norton-map.md) |
| Generated at | `2026-06-13T16:48:40Z` |
| Git commit | `493d797` |
| Script version | `3` |
| Output path | `docs/workspace/norton-texts/lyotard-defining-postmodern.md` |
...
<li>Thinker: <a href="../../thinkers/jean-francois-lyotard/">Jean-Francois Lyotard</a></li>
