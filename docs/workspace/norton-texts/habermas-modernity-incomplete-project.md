...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> modernity, enlightenment, culture, public-reason</span>
</div>
...
<section class="ah-passage-card">
  ...
  <p><strong>Review pressure:</strong> 10 rows. mixed_author_transition_page: 10<br>selection_boundary_review: 10</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 1793-1802.</p>
  <p><strong>Rights mode:</strong> restricted private notes until a public-domain or otherwise usable reading copy is selected.</p>
  <p><strong>Use:</strong> Find the passages that make this text active inside commentary-and-afterlife, education-and-civic-life, media-and-form, aesthetic-education-and-citizenship, labor-ideology-and-culture, language-truth-and-fiction.</p>
</section>

<section class="ah-passage-card">
  <span class="ah-action-kicker">Review Before Quoting</span>
  <h3>Layout, Notes, And Bibliography</h3>
  <p><strong>Review signal:</strong> mixed_author_transition_page: 10<br>selection_boundary_review: 10</p>
...
| Field | Value |
| --- | --- |
| Text ID | `habermas-modernity-incomplete-project` |
| Curated title | Modernity - An Incomplete Project |
...
| Git commit | `90b00be` |
| Script version | `3` |
| Output path | `docs/workspace/norton-texts/habermas-modernity-incomplete-project.md` |
