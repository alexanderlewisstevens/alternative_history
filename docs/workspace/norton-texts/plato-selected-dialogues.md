...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> mimesis, writing, memory, pedagogy</span>
</div>
...
This note turns the current Norton chunk for Plato into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 75-127</h3>
  <p><strong>Page count:</strong> 53</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/plato.md</code></p>
  <p><strong>Page kinds:</strong> excerpt: 49<br>author_intro: 4</p>
  <p><strong>Review pressure:</strong> 29 rows. multi_column_layout: 26<br>source_notes_detected: 17<br>layout_review_required: 6</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Review signal:</strong> multi_column_layout: 26<br>source_notes_detected: 17<br>layout_review_required: 6</p>
...
| Field | Value |
| --- | --- |
| Text ID | `plato-selected-dialogues` |
| Curated title | Selected dialogues |
| Creator | Plato |
| Thinker note | [Plato](../thinkers/plato.md) |
