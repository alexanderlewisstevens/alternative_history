...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> discipline, institution, power, normalization</span>
</div>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 1675-1691.</p>
...
| Field | Value |
| --- | --- |
| Text ID | `foucault-discipline-and-punish` |
| Curated title | Discipline and Punish |
