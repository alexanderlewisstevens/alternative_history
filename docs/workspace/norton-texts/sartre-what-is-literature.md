...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> literature, freedom, responsibility, reader</span>
</div>
...
This note turns the current Norton chunk for Jean-Paul Sartre into a navigable workspace node. Use it to move between the restricted draft, the curated text spine, the first constellations, and the review queue before writing public-facing commentary.

## Current Chunk

<section class="ah-passage-card">
  <span class="ah-action-kicker">Chunk Status</span>
  <h3>Norton Pages 1380-1393</h3>
  <p><strong>Page count:</strong> 14</p>
  <p><strong>Restricted draft:</strong> <code>generated/authors/norton-theory-criticism/jean-paul-sartre.md</code></p>
  <p><strong>Page kinds:</strong> excerpt: 14</p>
  <p><strong>Review pressure:</strong> 14 rows. mixed_work_transition_page: 14</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 1380-1393.</p>
...
<section class="ah-passage-card">
  ...
  <p><strong>Review signal:</strong> mixed_work_transition_page: 14</p>
...
| Field | Value |
| --- | --- |
| Text ID | `sartre-what-is-literature` |
| Curated title | What Is Literature? |
| Creator | Jean-Paul Sartre |
| Thinker note | [Jean-Paul Sartre](../thinkers/jean-paul-sartre.md) |
| Register status | `edition-review-needed` |
| Source anthology | The Norton Anthology of Theory and Criticism |
| Source rights status | `copyrighted` |
| Restricted draft | `generated/authors/norton-theory-criticism/jean-paul-sartre.md` |
| Workspace map | [Norton Workspace Map](../norton-map.md) |
| Generated at | `2026-06-13T07:13:46Z` |
| Git commit | `525b073` |
| Script version | `3` |
| Output path | `docs/workspace/norton-texts/sartre-what-is-literature.md` |
...
<li>Thinker: <a href="../../thinkers/jean-paul-sartre/">Jean-Paul Sartre</a></li>
