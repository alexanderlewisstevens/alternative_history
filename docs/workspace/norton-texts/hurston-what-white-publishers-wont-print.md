...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> publishing, race, representation, artistic-freedom</span>
</div>
...
<section class="ah-passage-card">
  ...
  <p><strong>Review pressure:</strong> 2 rows. multi_column_layout: 2<br>source_notes_detected: 1</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 1203-1206.</p>
  <p><strong>Rights mode:</strong> restricted private notes until a public-domain or otherwise usable reading copy is selected.</p>
  <p><strong>Use:</strong> Find the passages that make this text active inside poetry-and-judgment, commentary-and-afterlife, education-and-civic-life, authorship-and-authority.</p>
</section>

<section class="ah-passage-card">
  <span class="ah-action-kicker">Review Before Quoting</span>
  <h3>Layout, Notes, And Bibliography</h3>
  <p><strong>Review signal:</strong> multi_column_layout: 2<br>source_notes_detected: 1</p>
...
| Field | Value |
| --- | --- |
| Text ID | `hurston-what-white-publishers-wont-print` |
| Curated title | What White Publishers Won&#x27;t Print |
