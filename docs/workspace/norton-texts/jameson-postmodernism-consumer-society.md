...
<div class="ah-note-meta">
  ...
  <span><strong>Tags:</strong> postmodernism, consumer-society, late-capitalism, media</span>
</div>
...
<section class="ah-passage-card">
  ...
  <p><strong>Review pressure:</strong> 15 rows. mixed_work_transition_page: 15</p>
</section>
...
<section class="ah-passage-card">
  ...
  <p><strong>Source location:</strong> Norton page range 2004-2018.</p>
  <p><strong>Rights mode:</strong> restricted private notes until a public-domain or otherwise usable reading copy is selected.</p>
  <p><strong>Use:</strong> Find the passages that make this text active inside taste-and-standards, media-and-form, art-utility-and-modern-life, labor-ideology-and-culture.</p>
</section>

<section class="ah-passage-card">
  <span class="ah-action-kicker">Review Before Quoting</span>
  <h3>Layout, Notes, And Bibliography</h3>
  <p><strong>Review signal:</strong> mixed_work_transition_page: 15</p>
...
| Field | Value |
| --- | --- |
| Text ID | `jameson-postmodernism-consumer-society` |
| Curated title | Postmodernism and Consumer Society |
...
| Git commit | `493d797` |
| Script version | `3` |
| Output path | `docs/workspace/norton-texts/jameson-postmodernism-consumer-society.md` |
